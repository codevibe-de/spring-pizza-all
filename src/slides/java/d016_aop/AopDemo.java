...
public class AopDemo {
    ...
    public static void main(String[] args) {
        ...
        CustomerService proxiedCustomerService = new CustomerService$Proxy(aspect, customerService);
        proxiedCustomerService.createCustomer(new Customer("Tom Test", null, null));
        ...
        proxiedCustomerService = (CustomerService) factoryBean.getObject();
...
class CustomerService$Proxy extends CustomerService {
    ...
    CustomerService$Proxy(SecurityCheckAspect aspect, CustomerService target) {
        this.aspect = aspect;
        this.target = target;
    }
...
class SecurityInvocationHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        this.aspect.before(method, args, originalBean);
